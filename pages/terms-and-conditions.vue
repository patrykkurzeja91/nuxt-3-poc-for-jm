  ...
  <section class="container mx-auto px-4">
    <div class="prose mx-auto max-w-screen-md py-24 lg:prose-xl">
      ...
      <p>
        ...
        registration and, within a few days, the finalist&apos;s official letter
        by post.
      </p>
      <p>All entries will be assessed by a 5-person committee.</p>
      <p>
        They will be experts in the field of aesthetic medicine, cosmetology,
        business and marketing. Information on the composition of the committee
        will be published on the website www.beautykingdomawards.co.uk and on
        our social media.
      </p>
      <p>
        During the final gala, winners from each category will be selected as
        well as an audience award in the voting during the gala.
      </p>
      <p>
        The prize will be a prestigious statuette and a possible award from the
        sponsors and partners of the gala.
      </p>
      <p>
        No cash alternatives will be offered. All rewards offered in connection
      ...
      <p>
        ...
        participation in the final gala will be made via our website. Payments
        collected online will be processed through a secure payment gateway and
        will appear on your bank statement as Beauty Kingdom Awards
      </p>
      <p>
        In the event that the organizers are forced to cancel the gala due to
        the coronavirus, ticket holders will receive a full refund. If the
        government places restrictions on the number of visitors that are lower
        than the ticket sales, we will refund the ticket on a last in, first out
        basis.
      </p>
      <p>
        Except for Covid-19, all payments are non-refundable unless otherwise
        noted. Any requests for reimbursement must be received in writing within
        21 days of the event and will be considered by management with no refund
      ...
      <p>
        ...
        you consent to the use of your image. Beauty Kingdom Awards have the
      ...
      <p>
        By registering a company in the competition, you agree to receive
        messages from the organizers, marketing agency, as well as their
        sponsors and partners.
      </p>
      <p>
        You also consent to PR activities and marketing activities with the
        media patrons of the event.
      </p>
      <p>
        Information about the nominated businesses will be made available on the
      ...
      <p>
        ...
        purchased ticket, you will not be able to enter.
      </p>
      <p>
        Beauty Kingdom Awards and E&amp;T Marketing Solutions ask for your
        details and answer a series of mandatory questions to enable us to
        understand the demographics and requirements of our audience for each
        event.
      </p>
      <p>
        You will also receive a post-event survey that will allow us to analyze
        the event results, attendee demographics, reasons for absences, and
        understand how to improve future events.
      </p>
      <p>
        If you wish to change or no longer receive any further communications
        from the Beauty Kingdom Awards and E&amp;T Marketing Solutions please
        use the &quot;manage preferences&quot; or &quot;unsubscribe&quot; links
        in your emails.
      </p>
      <p>
