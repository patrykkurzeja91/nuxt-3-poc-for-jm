  ...
  <section class="bg-new-gray">
    <div class="container mx-auto max-w-screen-lg px-5 py-24">
      <div class="mb-20 text-center">
        <h2 class="mb-4 sm:text-3xl">What. When. Where.</h2>
      </div>
      <div class="subheading relative py-12 font-bold">
        <h5 class="relative inline-flex">BEAUTY AWARDS KEY DATES</h5>
      </div>
      <MoleculesKeyDates class="pb-32" />
      <div class="mb-20 rounded-md bg-white py-8 px-12">
        <p
          class="mb-4 inline-flex items-center justify-center text-2xl font-semibold"
        >
          <img
          ...
          />
          The final gala will take place on April 23, 2023.
        </p>
        <p class="text-2xl">
