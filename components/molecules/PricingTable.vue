    ...
    <div class="container mx-auto px-5 py-24">
      ...
      <div class="flex -m-4 flex-wrap">
        <div class="w-full p-4 lg:w-1/3">
          <div
            class="flex relative h-full flex-col overflow-hidden rounded-lg border-2 border-light-grayish-blue-100 bg-white/70 p-6 drop-shadow-2xl backdrop-blur-md"
          >
            <h2 class="title-font mb-1 text-sm font-medium tracking-widest">
              SILVER
            </h2>
            <h1
              class="flex mb-4 items-center border-b border-light-grayish-blue-100 pb-4 text-5xl leading-none text-gray-900"
            >
              <span>£56,99 </span>
              <!-- <span class="ml-1 text-lg font-normal text-light-grayish-blue-800">/mo</span> -->
            </h1>
            <p class="flex mb-2 items-center text-gray-600">
              <span
                class="mr-2 inline-flex h-4 w-4 flex-shrink-0 items-center justify-center rounded-full bg-light-grayish-blue-500 text-white"
              >
                <svg
                  fill="none"
                  stroke="currentColor"
            ...
            <p class="flex mb-6 items-center text-gray-600">
              <span
                class="mr-2 inline-flex h-4 w-4 flex-shrink-0 items-center justify-center rounded-full bg-light-grayish-blue-500 text-white"
              >
                <svg
            ...
            <p class="mt-3 text-xs text-light-grayish-blue-800">
        ...
        <div class="w-full p-4 lg:w-1/3">
          <div
            class="flex relative h-full flex-col overflow-hidden rounded-lg border-2 border-dark-golden bg-white/70 p-6 drop-shadow-2xl backdrop-blur-md"
          >
            <span
