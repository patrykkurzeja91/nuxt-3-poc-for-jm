      ...
      <div class="-m-4 flex flex-wrap">
        <div class="p-4 md:w-1/2 xl:w-1/3">
          <div class="rounded-md border border-gray-200 p-6">
            ...
            <h2 class="title-font mb-2 text-lg">Shooting Stars</h2>
        ...
        <div class="p-4 md:w-1/2 xl:w-1/3">
          <div class="rounded-md border border-gray-200 p-6">
            ...
            <h2 class="title-font mb-2 text-lg">The Catalyzer</h2>
            <p class="text-base leading-relaxed">
              Fingerstache flexitarian street art 8-bit waist co, subway tile
              poke farm.
            </p>
        ...
        <div class="p-4 md:w-1/2 xl:w-1/3">
          <div class="rounded-md border border-gray-200 p-6">
            ...
            <h2 class="title-font mb-2 text-lg">Neptune</h2>
            <p class="text-base leading-relaxed">
              Fingerstache flexitarian street art 8-bit waist co, subway tile
              poke farm.
            </p>
        ...
        <div class="p-4 md:w-1/2 xl:w-1/3">
          <div class="rounded-md border border-gray-200 p-6">
            ...
            <h2 class="title-font mb-2 text-lg">Melanchole</h2>
            <p class="text-base leading-relaxed">
              Fingerstache flexitarian street art 8-bit waist co, subway tile
              poke farm.
            </p>
        ...
        <div class="p-4 md:w-1/2 xl:w-1/3">
          <div class="rounded-md border border-gray-200 p-6">
            ...
            <h2 class="title-font mb-2 text-lg">Bunker</h2>
            <p class="text-base leading-relaxed">
              Fingerstache flexitarian street art 8-bit waist co, subway tile
              poke farm.
            </p>
        ...
        <div class="p-4 md:w-1/2 xl:w-1/3">
          <div class="rounded-md border border-gray-200 p-6">
            ...
            <h2 class="title-font mb-2 text-lg">Ramona Falls</h2>
            <p class="text-base leading-relaxed">
              Fingerstache flexitarian street art 8-bit waist co, subway tile
              poke farm.
            </p>
