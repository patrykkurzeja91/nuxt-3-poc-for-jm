...
<template>
  <div
    :class="{
      'border-dark-golden': popular === 'bestSeller',
  ...
  >
    <span
      v-if="popular"
      :class="{
        'bg-dark-golden': popular === 'bestSeller',
        'bg-royal-blue': popular === 'popular',
      }"
      class="absolute right-0 top-0 rounded-bl px-3 py-1 text-xs tracking-widest text-white"
    >
      {{ popular === 'popular' ? 'POPULAR' : 'BEST SELLER' }}</span
    >
    ...
    <nuxt-link
      :class="{
        'bg-dark-golden text-white hover:bg-dark-orange':
          popular === 'bestSeller',
        'bg-royal-blue text-white hover:bg-yale-blue': popular === 'popular',
        'border-2 border-yale-blue bg-white text-royal-blue hover:bg-yale-blue hover:text-white':
          popular === '',
      }"
      class="mt-auto flex w-full items-center rounded border-0 py-2 px-4 focus:outline-none"
      to="/contact"
    >
      Contact us
      <svg
