<template>
  <section class="bg-new-gray py-24">
    ...
    >
      <form class="max-w-xl text-center">
        <h2 class="mb-10">Check out our newsletter today!</h2>
        ...
        <div class="flex flex-row items-center">
          <AtomsBaseInput v-model="email" class="w-full" />
          {{ email }}
          <a
            href="#"
            class="ml-6 inline-flex items-center justify-center rounded-md bg-royal-blue px-10 py-2 text-center text-base font-medium text-white hover:bg-yale-blue"
          >
            Submit
          </a>
